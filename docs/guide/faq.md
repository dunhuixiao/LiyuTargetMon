...
![An image](https://cdn.jsdelivr.net/gh/dunhuixiao/LiyuTargetMon@docs/image/6.png)

### 如果我想要添加自己单独的监控怎么办？

找到你想要添加 Buff / Debuff 名称，「茗伊插件集-目标-目标监控-设置监控」中新建后调整即可。

![An image](https://cdn.jsdelivr.net/gh/dunhuixiao/LiyuTargetMon@docs/image/7.png)
...
![An image](https://cdn.jsdelivr.net/gh/dunhuixiao/LiyuTargetMon@docs/image/20220430030348.png)

该监控默认监控白云，如果你需要监控小剑、斧头或是其他标记，请打开文件修改 uuid 保存后导入，再修改监控目标。

![An image](https://cdn.jsdelivr.net/gh/dunhuixiao/LiyuTargetMon@docs/image/20220430030600.png)

![An image](https://cdn.jsdelivr.net/gh/dunhuixiao/LiyuTargetMon@docs/image/20220430030751.png)

默认显示位置在此处，如果修改导入了多个白云监控会重叠在一起，请自行拖拽到你习惯的位置。

![An image](https://cdn.jsdelivr.net/gh/dunhuixiao/LiyuTargetMon@docs/image/20220430030945.png)
